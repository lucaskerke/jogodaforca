...
const opacidadeOlhos = 0;

const categorias = {
    frutas: ["banana", "maca", "laranja", "mamao"],
    profissoes: ["engenheiro", "advogado", "medico", "professor"],
    animais: ["papagaio", "urubu", "cachorro", "gato"],
    cores: ["amarelo", "azul", "laranja", "roxo"]
};
...
function tentativa(letra){
    if(palavraProposta.includes(letra)){
        atualializaPalavraInterface(letra);
    }else{
...
function atualializaPalavraInterface(letra){
    let palavraAux = "";
